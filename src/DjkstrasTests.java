...
public class DjkstrasTests<V, E extends IWeight> {
...
//	@Test
//	public void testShortestPathABCDFZ() {	
//		graph.addVertex("A");
//		graph.addVertex("B");
//		graph.addVertex("C");
//		graph.addVertex("D");
...
//		graph.addEdge("A", "B", (E) new EdgeData(3));
//		graph.addEdge("A", "C", (E) new EdgeData(3));	
//		graph.addEdge("A", "D", (E) new EdgeData(2));
//		graph.addEdge("A", "Z", (E) new EdgeData(1));
//		
//		graph.addEdge("B", "F", (E) new EdgeData(1));
//		graph.addEdge("C", "F", (E) new EdgeData(1));
//		graph.addEdge("D", "F", (E) new EdgeData(1));
//		
//		graph.addEdge("Z", "A", (E) new EdgeData(1));
//		graph.addEdge("Z", "B", (E) new EdgeData(1));
//		
//		
//		List<Edge<E>> shortestPath = new ArrayList<>();
//		
//		//ADF or AZBF, both are 3
//		
//		shortestPath.add(new Edge("A", "B", (E) new EdgeData(1))); 
//		shortestPath.add(new Edge("B", "E", (E) new EdgeData(1))); 
//		
